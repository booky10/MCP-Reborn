...
#### MCP-Reborn is an MCP (Mod Coder Pack) for minecraft ~~for making modded clients for minecraft~~ (please don't), useful for researching its code. It is based on MCPConfig and ForgeGradle by MinecraftForge Team.
...
1. Quit modding and install fabric
2. Download sodium from [here](https://modrinth.com/mod/sodium)

Congratulations! You just got good FPS, but without "fast" math and other unncessarry shit.
